    ...
    return (
        <div className="profileMoreInfo">
            <div className="profileMoreInfoDiv">
                ...
                <div className="profMoreInfoBlock profMoreInfoBlock2 profMobileHiddenBlock2" active={!mobileInfoHidden + ""}>
            ...
            <div className="profileMoreInfoDiv passwordContentDiv" active={!mobileInfoHidden + ""}>
