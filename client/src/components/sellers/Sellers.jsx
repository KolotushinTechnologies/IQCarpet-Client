...
import "./Sellers.css";
import SellerCardTestIcon from "../../img/sellerCardTestIcon.png";
    ...
    return <Fragment>
        ...
        <div className="sellersContentDiv">
            <Filter>
                ...
                <FilterField name="Material" params={["Woole", "Silk", "Cotton", "Jute"]} />
                <FilterField name="Form" params={["Rectangle", "Square", "Oval", "Circle"]} />
            </Filter>
