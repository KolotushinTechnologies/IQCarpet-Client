        ...
        <div className="footer">
            <div className="footerContent1">
                <div className="footerContent1Block1">
                    <div class="footerHeaderDiv">
                        ...
                        <p className="footerText">Maecenas nec rutrum odio. Sed scelerisque urna eget augue laoreet, eget ultrices nisi aliquet.</p>
                ...
                <div className="footerContent1Block2">
                    ...
                    <div className="sendEmailDiv">
                        <input className="signUpForMessagesEmail" placeholder="Enter your e-mail"></input>
            ...
            <div className="footerContent2">
                <div className="footerContent2Block1">
                    <a href="" className="footerNavigationText">Home</a>
                    <a href="" className="footerNavigationText">Sellers</a>
                    <a href="" className="footerNavigationText">How it works</a>
                    <a href="" className="footerNavigationText">Support</a>
                </div>
