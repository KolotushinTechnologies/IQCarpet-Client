    ...
    return <Fragment>
        <div className="authorizingBlock">
            ...
            <div className="authField">
                ...
                <input className="authFieldInput" placeholder="Login or Email"></input>
            </div>
            <span className="passRecInfoCode">We will send to you a confirmation code</span>
        ...
        <div className="authorizingBlock passRecoveryBlock">
            <div className="authField confirmCodeField">
                ...
                <input className="authFieldInput confirmCodeInput" placeholder="Code"></input><span className="repeatSending" sended={codeSended.toString()}>Repeat sending</span><span className="sendTimer" sended={codeSended.toString()}>2:34</span>
            </div>
            <div class="submitButtonDiv">
                <button class="submitButton">Confirm</button>
            </div>
